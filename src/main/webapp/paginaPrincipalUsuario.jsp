        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/ford.jpg" class="d-block w-100" alt="Vehículo 1">
                </div>
                <div class="carousel-item">
                    <img src="img/mazda1.jpg" class="d-block w-100" alt="Vehículo 2">
                </div>
                <div class="carousel-item">
                    <img src="img/camaro.jpg" class="d-block w-100" alt="Vehículo 3">
                </div>
            </div>
